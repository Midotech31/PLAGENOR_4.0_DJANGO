...
LABELS={
    ...
    'cas':_('Numéro CAS'),'catalog_reference':_('Référence catalogue'),'grade':_('Grade / pureté'),
    'format':_('Format'),'packaging':_('Conditionnement décrit'),'specifications':_('Spécifications techniques'),
    'storage_instructions':_('Consignes de conservation'),
    ...
    'serial_number':_('Numéro de série'),'barcode':_('Code fabricant / GS1'),'control_notes':_('Notes de contrôle / provenance'),
...
SCHEMAS={
    ...
    'INITIAL':{'required':['article_code','location_code','lot_code','manufacturer_lot','container_code','amount','unit_code','received_on','condition'],
        'optional':['expires_on','manufactured_on','supplier_code','cold_chain_ok','unit_price_base','currency','serial_number','barcode','control_notes','new_name','new_category_code','new_base_unit_code']},
    'RECEIPTS':{'required':['article_code','location_code','lot_code','manufacturer_lot','container_code','amount','unit_code','received_on','condition'],
        'optional':['expires_on','manufactured_on','supplier_code','cold_chain_ok','unit_price_base','currency','order_reference','serial_number','barcode','control_notes']},
