...
urlpatterns = [
    ...
    path('cdc/<uuid:dossier_id>/sections/new/', cdc_views.cdc_section_edit, name='cdc-section-create'),
    path('cdc/<uuid:dossier_id>/sections/<uuid:pk>/', cdc_views.cdc_section_edit, name='cdc-section-edit'),
