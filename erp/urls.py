...
urlpatterns = [
    ...
    path('inventory-source/', views.inventory_source, name='inventory-source'),
    path('inventory-source/apply/', views.inventory_source_apply, name='inventory-source-apply'),
