    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind', models.CharField(choices=[('MANDATORY', 'Obligatoire'), ('MINIMUM', 'Minimum'), ('PREFERRED', 'Souhaitable'), ('SCORED', 'Notée'), ('INFORMATIONAL', 'Informative'), ('ELIMINATORY', 'Éliminatoire')], max_length=16, verbose_name="Nature de l’exigence")),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('item', 'position'), name='erp_cdc_requirement_position'),
        ),
        migrations.CreateModel(
            name='CdcCriterion',
            fields=[
                ...
                ('method', models.CharField(choices=[('PROPORTIONAL', 'Proportionnelle'), ('BINARY', 'Binaire'), ('INVERSE_PRICE', 'Prix inverse')], default='PROPORTIONAL', max_length=16, verbose_name='Méthode')),
                ('weight', models.DecimalField(decimal_places=2, max_digits=5, validators=[django.core.validators.MinValueValidator(Decimal('0')), django.core.validators.MaxValueValidator(Decimal('100'))], verbose_name='Pondération (points)')),
                ('threshold', models.DecimalField(blank=True, decimal_places=2, max_digits=8, null=True, verbose_name='Seuil éventuel')),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('dossier', 'code'), name='erp_cdc_criterion_code'),
        ),
        migrations.AddConstraint(
            model_name='cdccriterion',
            constraint=models.CheckConstraint(condition=models.Q(('weight__gte', 0), ('weight__lte', 100)), name='erp_cdc_criterion_weight'),
        ),
        migrations.CreateModel(
            name='CdcClause',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('DRAFT', 'Brouillon'), ('ACTIVE', 'Validée / active'), ('RETIRED', 'Retirée')], default='DRAFT', max_length=8)),
                ('sha256', models.CharField(max_length=64)),
                ('actor', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
                ('clause', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='revisions', to='erp.cdcclause')),
            ],
            options={'ordering': ['-number']},
        ),
        migrations.AddConstraint(
            model_name='cdcclauserevision',
            constraint=models.UniqueConstraint(fields=('clause', 'number'), name='erp_cdc_clause_revision_number'),
        ),
        migrations.AddField(
            model_name='cdcclause',
            name='active_revision',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='active_for', to='erp.cdcclauserevision'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('revision', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='selections', to='erp.cdcclauserevision')),
            ],
            options={'ordering': ['position', 'id']},
        ),
        migrations.AddConstraint(
            model_name='cdcclauseselection',
            constraint=models.UniqueConstraint(fields=('dossier', 'revision'), name='erp_cdc_clause_selection_unique'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('stage', models.CharField(choices=[('TECHNICAL', 'Revue technique'), ('ADMIN_LEGAL', 'Revue administrative et juridique'), ('FINANCIAL', 'Revue financière')], max_length=16)),
                ('outcome', models.CharField(choices=[('APPROVED', 'Approuvée'), ('CHANGES', 'Corrections demandées')], max_length=12)),
                ('comment', models.CharField(max_length=1000, verbose_name='Compte rendu')),
                ('actor', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL)),
                ('dossier', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='review_decisions', to='erp.cdcdossier')),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('revision', 'stage'), name='erp_cdc_review_stage_unique'),
        ),
    ]
