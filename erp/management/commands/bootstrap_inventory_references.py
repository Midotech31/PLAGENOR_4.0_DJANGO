...
UNITS = [
    ...
    {'code': 'G', 'name': 'Gramme', 'name_en': 'Gram', 'name_ar': 'غرام',
     'dimension': Unit.Dimension.MASS, 'factor': Decimal('1')},
    {'code': 'ML', 'name': 'Millilitre', 'name_en': 'Millilitre', 'name_ar': 'ملليلتر',
     'dimension': Unit.Dimension.VOLUME, 'factor': Decimal('1')},
...
CATEGORIES = [
    ...
    {'code': 'CHEMICAL', 'name': 'Produits chimiques', 'name_en': 'Chemicals', 'name_ar': 'مواد كيميائية'},
    {'code': 'CONSUMABLE', 'name': 'Consommables', 'name_en': 'Consumables', 'name_ar': 'مستهلكات'},
    {'code': 'REAGENT', 'name': 'Réactifs', 'name_en': 'Reagents', 'name_ar': 'كواشف'},
]
LOCATION_TYPES = [
    {'code': 'SITE', 'name': 'Site', 'name_en': 'Site', 'name_ar': 'موقع',
     'can_store': False, 'cold_storage': False},
    {'code': 'ROOM', 'name': 'Salle / zone de stockage', 'name_en': 'Room / storage area',
