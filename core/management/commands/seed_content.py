...
DEFAULTS_AR = {
    ...
    'org_description': 'PLAGENOR هي الأرضية التكنولوجية للجينوميك التابعة للمدرسة العليا في العلوم البيولوجية بوهران. تستقبل طلبات الطلبة الجزائريين عبر منصة إبتكار وطلبات الخدمات العلمية والتقنية.',
    'footer_brand': 'PLAGENOR 4.0',
    'footer_description': 'PLAGENOR — الأرضية التكنولوجية للجينوميك التابعة للمدرسة العليا في العلوم البيولوجية بوهران. طلبات التحليل ومتابعة الخدمات وتسليم النتائج.',
    ...
    'about_intro': 'تستضيف المدرسة العليا في العلوم البيولوجية بوهران منصة PLAGENOR، خدمة بحثية مشتركة ممولة من DGRSDT.',
    'about_genoclab': 'تستضيف PLAGENOR شركة جينوصيلاب، الفرع التجاري للمدرسة العليا في العلوم البيولوجية بوهران، الخاضع لقانون التجارة الجزائري.',
...
DEFAULTS_EN.update({
 ...
 'genoclab_contact_email': 'genoclab.essbo@gmail.com'})
DEFAULTS_AR.update({
    'footer_brand': 'الأرضية التكنولوجية للجينوميك',
    ...
    'footer_credit': 'الأرضية التكنولوجية للجينوميك — تصميم البروفيسور محمد مرزوق | المدرسة العليا في العلوم البيولوجية بوهران',
