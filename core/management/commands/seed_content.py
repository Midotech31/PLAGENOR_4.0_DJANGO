...
DEFAULTS_AR = {
    'nav_brand': 'بلاجينور 4.0',
    'hero_title': 'بلاجينور 4.0',
    'hero_subtitle': 'الأرضية التكنولوجية للجينوميك — المدرسة العليا في العلوم البيولوجية بوهران · وهران',
    'hero_description': 'حل متكامل لإدارة طلبات التحليل ومتابعة العمليات والفوترة داخل المدرسة العليا في العلوم البيولوجية بوهران.',
    'hero_btn_submit': 'إرسال طلب',
    'hero_btn_guest': 'إرسال كزائر',
    'hero_btn_services': 'عرض الخدمات',
    'hero_btn_track': 'تتبع الطلب',
    'ibtikar_title': 'منصة إبتكار',
    'ibtikar_description': 'خدمات منصة إبتكار متاحة للطلبة الجزائريين، مهما كانت مؤسسة انتمائهم. قدّموا طلبات التحليل لمشاريعكم الدراسية والبحثية وفق شروط برنامج إبتكار.',
    'genoclab_title': 'جينوصيلاب',
    ...
    'org_title': 'التنظيم',
    'org_subtitle': 'المدرسة العليا في العلوم البيولوجية بوهران → الأرضية التكنولوجية للجينوميك → جينوصيلاب',
    'org_description': 'الأرضية التكنولوجية للجينوميك التابعة للمدرسة العليا في العلوم البيولوجية بوهران. تستقبل طلبات الطلبة الجزائريين عبر منصة إبتكار وطلبات الخدمات العلمية والتقنية.',
    ...
    'about_title': 'حول الأرضية التكنولوجية للجينوميك',
    'about_intro': 'تستضيف المدرسة العليا في العلوم البيولوجية بوهران الأرضية التكنولوجية للجينوميك، خدمة بحثية مشتركة ممولة من DGRSDT.',
    'about_genoclab': 'تستضيف الأرضية التكنولوجية للجينوميك شركة جينوصيلاب، الفرع التجاري للمدرسة العليا في العلوم البيولوجية بوهران، الخاضع لقانون التجارة الجزائري.',
    'about_plagenor': 'تتيح بلاجينور 4.0 تقديم طلبات التحليل ومتابعتها وإدارة الخدمات والاطلاع على الوثائق والنتائج.',
    ...
    'contact_institution': 'المدرسة العليا في العلوم البيولوجية بوهران',
    'contact_address': 'المدرسة العليا في العلوم البيولوجية بوهران، وهران، الجزائر',
    'contact_email': 'genomicsplatform.essbo@gmail.com',
    'contact_phone': '+213 (0) 41 XX XX XX',
    'contact_name': 'البروفيسور محمد مرزوق',
    'contact_platform': 'بلاجينور 4.0',
    'login_title': 'تسجيل الدخول',
    'login_subtitle': 'ادخل إلى مساحتك في الأرضية التكنولوجية للجينوميك',
    'login_logo_text': 'بلاجينور 4.0',
    'login_logo_sub': 'منصة إدارة العمليات',
    'login_footer_1': 'المدرسة العليا في العلوم البيولوجية بوهران',
