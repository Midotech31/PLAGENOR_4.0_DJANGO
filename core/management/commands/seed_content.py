...
DEFAULTS_AR = {
    ...
    'ibtikar_description': 'خدمات منصة إبتكار متاحة للطلبة الجزائريين، مهما كانت مؤسسة انتمائهم. قدّموا طلبات التحليل لمشاريعكم الدراسية والبحثية وفق شروط برنامج IBTIKAR.',
    ...
    'about_genoclab': 'تستضيف PLAGENOR شركة جينوصيلاب، الفرع التجاري لـ المدرسة العليا في العلوم البيولوجية بوهران، الخاضع لقانون التجارة الجزائري.',
