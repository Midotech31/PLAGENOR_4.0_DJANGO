...
LABELS_FR = {
    ...
    'platform_note_section5': 'Section 5 — Devis détaillé',
    'calculated_cost': 'Coût calculé',
    'discount_applied': 'Remise appliquée',
    'final_cost': 'MONTANT TOTAL (DZD)',
    'cost_breakdown': 'Détail du devis',
    ...
    'formula_label': 'Formule de calcul',
    'modifiers_applied': 'Modificateurs appliqués (mode analyse / urgence)',
    'base_price_per_sample': 'Prix de base / échantillon',
    'per_sample_supplements': 'Suppléments / échantillon',
    'supplement_reason': 'Détail des suppléments par échantillon',
    'sample_notes': 'Remarques',
    'urgency_label': 'Niveau d\'urgence',
    'budget_amount': 'Budget déclaré (demandeur)',
    'platform_note_section6': 'Section 6 — Livrables',
    'deliverables': 'Livrables',
    'platform_note_section7': 'Section 7 — Contact du laboratoire',
    'platform_note_section8': 'Section 8 — Délai estimé',
    'lab_contact_section': 'Section 7 — Contact du laboratoire',
    'lab_name': 'Laboratoire',
    'lab_address': 'Adresse',
    'lab_phone': 'Téléphone',
    'lab_email': 'Email',
...
LABELS_EN = {
    ...
    'platform_note_section5': 'Section 5 — Detailed Quote',
    'calculated_cost': 'Calculated Cost',
    'discount_applied': 'Discount Applied',
    'final_cost': 'TOTAL AMOUNT (DZD)',
    ...
    'formula_label': 'Calculation Formula',
    'modifiers_applied': 'Applied Modifiers (analysis mode / urgency)',
    'base_price_per_sample': 'Base Price / Sample',
    'per_sample_supplements': 'Supplements / Sample',
    'supplement_reason': 'Per-sample supplement details',
    'sample_notes': 'Notes',
    'urgency_label': 'Urgency Level',
    'budget_amount': 'Declared Budget (requester)',
    'platform_note_section6': 'Section 6 — Deliverables',
    'deliverables': 'Deliverables',
    'platform_note_section7': 'Section 7 — Laboratory Contact',
    'platform_note_section8': 'Section 8 — Estimated Turnaround',
    'lab_contact_section': 'Section 7 — Laboratory Contact',
    'lab_name': 'Laboratory',
    'lab_address': 'Address',
    'lab_phone': 'Phone',
    'lab_email': 'Email',
